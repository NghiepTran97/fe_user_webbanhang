    ...
    <>
        ...
        <div className="container-fluid mb-5">
            <div className="row border-top px-xl-5">
                <div className="col-lg-3 d-none d-lg-block">
                    <a 
                        className="btn shadow-none d-flex align-items-center justify-content-between bg-primary text-white w-100" data-toggle="collapse"
        ...
        <div className="container-fluid bg-secondary text-dark mt-5 pt-5">
            <div className="row px-xl-5 pt-5">
                <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    ...
                    <p className="mb-2">
                        <FaMapMarkerAlt className="text-primary mr-3" />123 Street, New York, USA
                    </p>
                    <p className="mb-2">
                        <FaEnvelope className="text-primary mr-3" />info@example.com
                    </p>
                    <p className="mb-0">
                        <FaPhone className="text-primary mr-3" />+012 345 67890
                    </p>
                </div>
